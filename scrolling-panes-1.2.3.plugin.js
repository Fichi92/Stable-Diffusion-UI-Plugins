...
(function () {
    ...
    function resizePromptField() {
        ...
        const promptTargetWidth = (promptField.offsetWidth + promptField.offsetLeft - negativePromptField.offsetLeft)
        if (promptTargetWidth > 0) {
            negativePromptField.style.width = promptTargetWidth + 'px'
            updatePreviewSize()
        }
    }
    ...
    function resizeNegativePromptField() {
        ...
        const negativePromptTargetWidth = (negativePromptField.offsetWidth - promptField.offsetLeft + negativePromptField.offsetLeft)
        if (negativePromptTargetWidth > 0) {
            promptField.style.width = negativePromptTargetWidth + 'px'
            updatePreviewSize()
        }
    }
